...
export type StaffStatTone = 'primary' | 'success' | 'neutral' | 'info';

const TONE: Record<StaffStatTone, { chip: string; bar: string; ring: string }> = {
  primary: {
...
/**
 * Staff overview stat tile — tone-tinted icon chip, label + figure + hint line,
 * and a thin tone accent bar. Clickable tiles act as status filters
 * (aria-pressed). Mirrors `QueueStatCard`.
 *
